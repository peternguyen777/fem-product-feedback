...
function EachComment({ item }) {
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between '>
        <div className='flex items-center'>
          ...
          <div className='ml-4 md:ml-8'>
            ...
            <p className='body3 font-normal text-gray'>@{item.user.username}</p>
          </div>
        </div>
        <p
      ...
      <p className='body3 relative mt-4 font-normal text-gray md:ml-[72px]'>
        {item.content}
        {item.replies && (
          <div
      ...
      <div className='md:ml-5'>
        {item?.replies?.map((reply, i) => {
          ...
          return (
            ...
            >
              <div className='vert-hr-last-hidden absolute -left-0 top-0 h-[calc(100%+44px)] w-1 border-l border-[#8C92B3] border-opacity-25 md:top-[20px] md:h-[calc(100%+20px)] lg:h-[calc(100%+32px)]' />
              <div className='flex items-center justify-between'>
                <div className='flex items-center'>
                  <Image
